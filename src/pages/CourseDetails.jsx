...
const CourseDetails = ()=> {
  ...
  return (
    <>
      <div className={`relative w-full bg-slate-800`}>
        ...
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:relative ">
          <div className="mx-auto grid min-h-[450px] max-w-maxContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
            ...
            <div
              className={`z-30 my-5 flex flex-col justify-center gap-4 py-5 text-lg text-slate-5`}
            >
              <div>
                <p className="text-4xl font-bold text-slate-5 sm:text-[42px]">
                  {courseName}
                </p>
              </div>
            ...
            <div className="flex w-full flex-col gap-4 border-y border-y-slate-500 py-4 lg:hidden">
      ...
      <div className="mx-auto box-content px-4 text-start text-slate-5 lg:w-[1260px]">
