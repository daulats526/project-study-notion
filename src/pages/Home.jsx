  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        <Link to={"/signup"}>
          <div className="group mx-auto mt-16 w-fit rounded-full bg-slate-800 p-1 font-bold text-slate-100 drop-shadow-[0_1.5px_rgba(255,255,255,0.25)] transition-all duration-200 hover:scale-95 hover:drop-shadow-none">
        ...
        {/* Sub Heading */}
        <div className="-mt-3 w-[90%] text-center text-lg font-bold text-slate-300">
        ...
        {/* Video */}
        <div className="mx-3 my-7 shadow-[10px_-5px_50px_-5px] shadow-blue-400 rounded-md">
          <video
